...
| `node_exporter_textfile_scripts_dir` | "/opt/node_exporter/textfile-collector" | Directory to store scripts for the [Textfile Collector](https://github.com/prometheus/node_exporter#textfile-collector).
